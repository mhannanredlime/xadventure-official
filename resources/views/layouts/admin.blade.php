...
<body>
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid">
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarCollapse" aria-controls="sidebarCollapse" aria-expanded="false" aria-label="Toggle sidebar">
      ...
      <div class="collapse navbar-collapse justify-content-end">
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle user-dropdown jatio-bg-color rounded-3" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">{{ Auth::user()->name ?? 'User' }}</a>
    ...
    <div class="sidebar collapse collapse-horizontal d-lg-block" id="sidebarCollapse">
      <div class="sidebar-content">
        <ul class="nav flex-column sidebar-menu">
          ...
          @can('dashboard.view')
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/reservation-dashboard') ? 'active' : '' }}" href="{{ url('/admin/reservation-dashboard') }}">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/view-reservation-dashboard') ? 'active' : '' }}" href="{{ url('/admin/view-reservation-dashboard') }}">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/slot-presets*') ? 'active' : '' }}" href="{{ url('/admin/slot-presets') }}">
          ...
          @can('packages.view')
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/add-packege-management*') || request()->is('admin/packages*') ? 'active' : '' }}" href="{{ url('/admin/add-packege-management') }}">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/vehical-setup*') || request()->is('admin/vehicle-types*') ? 'active' : '' }}" href="{{ url('/admin/vehical-setup') }}">
          ...
          @can('vehicles.view')
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/vehical-management*') || request()->is('admin/vehicles*') ? 'active' : '' }}" href="{{ url('/admin/vehical-management') }}">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('admin/promo*') || request()->is('admin/promo-codes*') ? 'active' : '' }}" href="{{ url('/admin/promo') }}">
          ...
          @can('users.view')
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is('admin/users*') ? 'active' : '' }}" href="#" id="userManagementDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
