...
<div class="container my-5">
    ...
    <div class="col">
      <div class="custom-card">
        ...
        <div class="card-body">
          ...
          <center>
            <a href="{{ url('/cart-2') }}" class="btn jatio-bg-color w-100"><i class="fa-solid fa-cart-shopping me-2"></i> Add to Cart</a>
          </center>
        </div>
      </div>
    </div>
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
    ...
    @endphp
    <div class="col">
      <div class="custom-card" data-package-id="{{ $package->id }}" @if($firstVariant) data-variant-id="{{ $firstVariant->id }}" @endif>
        <img src="{{ $img }}" class="card-img-top" alt="{{ $package->name }}">
        <div class="card-body">
          <h5 class="card-title">{{ $package->name }}</h5>
          <p class="card-text">30 (min) Guided Tour<br><span class="price-text" data-price-for-variant="{{ $firstVariant->id ?? '' }}">TK 0</span></p>
          <center>
