...
<script>
  ...
  $('#apply-promo-btn').click(function() {
    ...
    .done(function(response) {
      if (response.valid) {
        $('#promo-message').html('<div class="text-success">Promo code applied successfully!</div>');
        $('#discount-row').show();
    ...
    .fail(function() {
      $('#promo-message').html('<div class="text-danger">Error applying promo code. Please try again.</div>');
    })
    .always(function() {
