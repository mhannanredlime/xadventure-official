        ...
        @if ($bundlePackages && $bundlePackages->count() > 0)
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mb-5">
                @foreach ($bundlePackages as $package)
                    ...
                    @endphp
                    <div class="col">
                        <div class="custom-card bundle-card" data-package-id="{{ $package->id }}"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Bundle Package<br><span class="price-text"
                                ...
                                <center>
                                    <div class="add-to-cart-container">
                                        <a href="#" class="btn jatio-bg-color w-100 btn-add-bundle"
                                            @if ($firstVariant) data-variant-id="{{ $firstVariant->id }}" @endif>
                                        ...
                                        <div class="quantity-controls" style="display: none;">
                                            <div class="quantity-selector jatio-bg-color w-100">
                                                ...
                                                <span class="quantity-text">{{ $package->min_participants }}
                                                    Bundle{{ $package->min_participants > 1 ? 's' : '' }}</span>
                ...
                <div class="col-lg-4 col-md-6 col-12" data-package-id="{{ $package->id }}"
                    ...
                    <div class="card figma-card shadow-sm border-0">
                        ...
                        <div class="figma-card-img-wrapper">
                            <img src="{{ $img }}" class="card-img-top" alt="bundle image">
                        </div>
                ...
                plusBtn.addEventListener('click', function() {
                    if (currentQuantity < maxParticipants) {
                        ...
                        toastNotifications.warning(
                            `Maximum ${maxParticipants} participants allowed for this package.`);
                    }
                });
                    ...
                    fetchJson(`/api/pricing/date?date=${today}&variant_id=${variantId}`)
                        .then(data => {
                            if (data && typeof data.final_price !== 'undefined') {
                                span.textContent = 'Starting from TK ' + Number(data.final_price)
                                    .toLocaleString();
                            } else {
