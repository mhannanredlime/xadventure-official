...
<div class="container adventure-container">
    ...
    <p>Get ready for mud, speed, and pure excitement at Xtreme Adventure Bandarban! After a quick safety briefing, gear up and tear through muddy terrain and rugged Bandarban jungle trails on your own ATV or UTV.</p>
    <p>Whether you're riding solo or with your adventure crew, this off-road thrill ride is the perfect way to crank up your trip. Choose from 30-minute to 1-hour ride options — fun guaranteed at every turn.</p>
    ...
    <ul>
        ...
        <li>Customer Service Hours: Our team is available daily from 10:00 AM - 7:00 PM to assist with bookings and inquiries.</li>
        <li>Booking Confirmation: A detailed confirmation message with your ride information will be sent upon successful payment.</li>
    </ul>

    <div class="policy-title">Reporting & Arrival Policy:</div>
    <ul>
        <li>Guests are strongly advised to arrive at least 30 minutes before their scheduled ride time for check-in and preparation.</li>
        <li>Late arrivals (arriving after the scheduled time) will miss the mandatory safety briefing and will not be permitted to ride.</li>
    ...
    <div class="row gx-5 align-items-center">
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <p class="faq-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.</p>
