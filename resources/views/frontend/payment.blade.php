    ...
    <div class="container mt-4" style="margin-top: 20% !important;">
            ...
            @if (isset($payment) && $payment)
                <div class="row">
                        ...
                        <div class="payment-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Date:</strong> {{ date('F j, Y', strtotime($payment->reservation->date)) }}
                                    </p>
                                    <p><strong>Status:</strong>
                                        <span
                                            class="badge {{ $payment->status === 'completed' ? 'bg-success' : 'bg-warning' }}">
                    ...
                    <div class="col-lg-4">
                        <div class="payment-form">
                            <h4>Quick Actions</h4>
                            <a href="{{ route('packages.custom.index') }}" class="btn btn-primary w-100 mb-2">
                                <i class="bi  bi-plus"></i> Book Another Adventure
                            </a>
                            <a href="{{ route('booking.process-checkout') }}" class="btn btn-outline-secondary w-100 mb-2">
            ...
            @else
                ...
                <div class="payment-form">
                    <div class="text-center">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('packages.custom.index') }}" class="btn btn-primary">
                                <i class="bi  bi-plus"></i> Book Another Adventure
                            </a>
        ...
        @elseif(session('error'))
            ...
            <div class="text-center mt-4">
                <a href="{{ route('booking.process-checkout') }}" class="btn btn-primary">
...
@push('scripts')
    <script>
        ...
        $('#payment-form').submit(function(e) {
            const requiredFields = ['customer_name', 'customer_email', 'customer_phone', 'card_holder',
