        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.vehicles.update', $vehicle) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('details') is-invalid @enderror"
                                    id="details" name="details" value="{{ old('details', $vehicle->details) }}">
                                @error('details')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('op_start_date') is-invalid @enderror"
                                    id="op_start_date" name="op_start_date"
                                    value="{{ old('op_start_date', $vehicle->op_start_date ? $vehicle->op_start_date->format('Y-m-d') : '') }}">
                                @error('op_start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary mt-2">Save Vehicle</button>
                        <a href="{{ route('admin.vehical-management') }}" class="btn btn-secondary mt-2">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
