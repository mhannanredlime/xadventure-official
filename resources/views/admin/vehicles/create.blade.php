...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.vehicles.store') }}" method="POST" enctype="multipart/form-data" onsubmit="updateFormData(this)">
                @csrf
                            ...
                            <select class="form-select @error('vehicle_type_id') is-invalid @enderror" id="vehicle_type_id" name="vehicle_type_id" required>
                                ...
                                @foreach($vehicleTypes as $type)
                                    <option value="{{ $type->id }}" 
                                            data-images="{{ $type->images->toJson() }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('op_start_date') is-invalid @enderror" id="op_start_date" name="op_start_date" value="{{ old('op_start_date') }}">
                            @error('op_start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
