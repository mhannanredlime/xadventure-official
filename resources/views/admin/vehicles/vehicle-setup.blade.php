...
@section('content')
                    ...
                    <div class="dropdown sort-dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                            <li><a class="dropdown-item {{ $sort === 'newest' ? 'active' : '' }}"
                                    href="{{ route('admin.vehicle-types.index', ['sort' => 'newest']) }}">Newest First</a>
                            </li>
                            <li><a class="dropdown-item {{ $sort === 'oldest' ? 'active' : '' }}"
                                    href="{{ route('admin.vehicle-types.index', ['sort' => 'oldest']) }}">Oldest First</a>
                            </li>
                            <li><a class="dropdown-item {{ $sort === 'name' ? 'active' : '' }}"
                                    href="{{ route('admin.vehicle-types.index', ['sort' => 'name']) }}">Name A-Z</a></li>
                            <li><a class="dropdown-item {{ $sort === 'name_desc' ? 'active' : '' }}"
                                    href="{{ route('admin.vehicle-types.index', ['sort' => 'name_desc']) }}">Name Z-A</a>
                            </li>
                        </ul>
                    </div>
                ...
                @forelse($vehicleTypes as $vehicleType)
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3" id="vehicleType-{{ $vehicleType->id }}">
                        <div class="card vehicle-card h-100">
                            <img src="{{ $vehicleType->displayImageUrl }}" class="card-img-top"
                            ...
                            <div class="card-body vehicle-card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted">
                                    {{ $vehicleType->subtitle ?: $vehicleType->seating_capacity . ' Seater ' . $vehicleType->name }}
                                </p>
                                <div class="creation-date">
                                    <i class="bi bi-calendar3"></i> Created:
                                    {{ $vehicleType->created_at->format('M d, Y') }}
                                </div>
    ...
    <div class="modal fade" id="deleteVehicleTypeModal" tabindex="-1" aria-labelledby="deleteVehicleTypeModalLabel"
        aria-hidden="true">
