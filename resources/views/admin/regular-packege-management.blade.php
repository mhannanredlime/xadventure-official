...
@section('content')
    ...
    <script>
        ...
        function updateFormData() {
            ...
            console.log('Checking multiple image upload instance...');
            if (multipleImageUpload && window.multipleImageUploadInstance) {
                ...
                console.log('Selected files from instance:', selectedFiles);
                ...
                if (selectedFiles && selectedFiles.length > 0) {
                    ...
                    console.log('Real files to upload:', realFiles.length);
                    ...
                    if (realFiles.length > 0) {
                        ...
                        console.log('Files attached to form input:', formImageInput.files.length);
                    }
                ...
                console.warn('Multiple image upload instance not found or container missing');
            }
        }
