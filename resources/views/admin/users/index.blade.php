                    ...
                    <form method="GET" action="{{ route('admin.users.index') }}" class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="user_type" name="user_type">
                                <option value="admin" {{ request('user_type') == 'admin' || !request('user_type') ? 'selected' : '' }}>Admin Only</option>
                                <option value="customer" {{ request('user_type') == 'customer' ? 'selected' : '' }}>Customer Only</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('admin.users.mark-as-admin', $user) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-outline-success" title="Mark as Admin" 
