    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('admin.vehicle-types.update', $vehicleType) }}" method="POST"
                    enctype="multipart/form-data" id="vehicleTypeForm" onsubmit="return updateFormData(this)" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name', $vehicleType->name) }}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('subtitle') is-invalid @enderror"
                                    id="subtitle" name="subtitle" value="{{ old('subtitle', $vehicleType->subtitle) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('seating_capacity') is-invalid @enderror"
                                    ...
                                    value="{{ old('seating_capacity', $vehicleType->seating_capacity) }}">
                    ...
                    <div class="form-group">
                        ...
                        <div id="multiple-image-upload" data-model-type="App\Models\VehicleType"
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (window.multipleImageUploadInstance) {
                    console.log('Multiple image upload instance found:', window
                    .multipleImageUploadInstance);
                } else {
